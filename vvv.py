...
async def callback(call: types.CallbackQuery):
    ...
    if call.data=="kl":
        ...
        await call.message.answer("Endi kiril matn yuboring.")

    elif call.data=="lk":
        user_mode[call.from_user.id]="lk"
        await call.message.answer("Endi lotin matn yuboring.")
...
async def text_handler(message: types.Message):
    ...
    if mode=="kl":
        result = kiril_lotin(message.text)
    else:
        result = lotin_kiril(message.text)
